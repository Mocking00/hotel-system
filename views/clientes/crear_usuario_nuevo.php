...
<head>
    ...
    <style>
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        .card{background:white;border-radius:12px;box-shadow:0 2px 10px rgba(0,0,0,.05);padding:25px;max-width:900px}
        ...
        .section-title{font-size:14px;font-weight:700;color:#444;margin:18px 0 10px}
...
<div class="main-content">
    <div class="header">
        <div>
            <h1>➕ Nuevo Usuario Cliente</h1>
            <div style="font-size:13px;color:#666">Crea credenciales y perfil de cliente en un solo paso</div>
        </div>
            ...
            <form method="POST" action="./ClienteController.php?accion=crear_usuario_nuevo">
                ...
                <div class="grid">
                    ...
                    <div class="full">
                        ...
                        <textarea name="direccion" placeholder="Opcional"><?= htmlspecialchars($datos['direccion'] ?? '') ?></textarea>
                    </div>
                </div>
                ...
                <div class="grid">
                    <div class="full">
                        ...
                        <input type="text" name="username" required value="<?= htmlspecialchars($datos['username'] ?? '') ?>" placeholder="ej: cliente.nuevo">
                    </div>
                    <div>
