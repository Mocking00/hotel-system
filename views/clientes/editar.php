...
<head>
    ...
    <style>
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        .btn-save{padding:10px 28px;background:#f39c12;color:white;border:none;border-radius:8px;cursor:pointer;font-size:14px;font-weight:600}
...
<div class="main-content">
    ...
    <div class="content-area">
        <div class="breadcrumb">
            ...
            <a href="/hotel-system/controllers/ClienteController.php?accion=detalle&id=<?= $datos['cliente_id'] ?>"><?= htmlspecialchars($datos['nombre'].' '.$datos['apellido']) ?></a> ›
            Editar
        </div>
        ...
        <form method="POST" action="/hotel-system/controllers/ClienteController.php?accion=editar&id=<?= $datos['cliente_id'] ?>">
        <div class="form-card">
            <h2>
                <span style="width:38px;height:38px;background:#f39c12;border-radius:50%;display:flex;align-items:center;justify-content:center;color:white;font-size:16px">✏️</span>
                Datos del Cliente
            </h2>
            <div class="form-grid">
            ...
            <div class="form-footer">
                <a href="/hotel-system/controllers/ClienteController.php?accion=detalle&id=<?= $datos['cliente_id'] ?>" class="btn-cancel">✕ Cancelar</a>
