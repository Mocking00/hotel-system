...
<div class="main-content">
    <div class="header">
        <div class="header-title">
            <h1>✏️ Editar Habitación #<?= htmlspecialchars($datos['numero']) ?></h1>
            <div class="header-subtitle">Modifica los datos de la habitación</div>
        </div>
    ...
    <div class="content-area">
        <div class="breadcrumb">
            <a href="<?= htmlspecialchars($habitacionesUrl) ?>">🛏️ Habitaciones</a>
        ...
        <div class="form-card">
            ...
            <form method="POST"
                  action="<?= htmlspecialchars($habitacionesUrl) ?>?accion=editar&id=<?= $datos['habitacion_id'] ?>"
                  id="formEditar">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        <label>Piso *</label>
                        <input type="number" name="piso" required min="1" max="50"
                               value="<?= htmlspecialchars($datos['piso']) ?>">
                    </div>

                    <div class="form-group">
                        <label>Capacidad (personas) *</label>
                        <input type="number" name="capacidad" required min="1" max="20"
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="precio_noche" required step="0.01" min="0.01"
                    ...
                    <div class="form-group">
                        ...
                        <select name="estado">
                            <?php
                            $opciones = ['disponible'=>'✅ Disponible','ocupada'=>'🔴 Ocupada','mantenimiento'=>'🔧 En mantenimiento'];
                            foreach ($opciones as $val => $label): ?>
                            <option value="<?= $val ?>" <?= $datos['estado'] === $val ? 'selected' : '' ?>>
                                <?= $label ?>
                            </option>
                            <?php endforeach; ?>
                        </select>
